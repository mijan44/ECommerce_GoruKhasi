/**
    Item Name: GoruKhasi - Ecommerce HTML Template.
...
(function($) {
    ...
    $("body").on("click", ".add-to-cart", function(){
        ...
        var p_html = '<li>'+
                        '<a href="product-left-sidebar.html" class="sidGoruKhasi_pro_img"><img src="'+ img_url +'" alt="product"></a>'+
    ...
    (function() {
        var $GoruKhasiToggle = $(".ec-side-toggle"),
        $GoruKhasi = $(".ec-side-cart"),
        $ecMenuToggle = $(".mobile-menu-toggle");

        $GoruKhasiToggle.on("click", function(e) {
            e.preventDefault();
            var $this = $(this),
    ...
    /*----------------------------- GoruKhasi Responsive Menu -----------------------------------*/
    function ResponsiveMobileGoruKhasiMenu() {
        var $GoruKhasiNav = $(".ec-menu-content, .overlay-menu"),
        $GoruKhasiNavSubMenu = $GoruKhasiNav.find(".sub-menu");
        $GoruKhasiNavSubMenu.parent().prepend('<span class="menu-toggle"></span>');

        $GoruKhasiNav.on("click", "li a, .menu-toggle", function(e) {
            var $this = $(this);
